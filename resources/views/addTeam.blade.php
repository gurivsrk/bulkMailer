            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div id="addForm">
                        ...
                        <form method="POST" action="{{ route('addPersonPost') }}">
                            @csrf
                            <!-- Email Address -->
                            <div>
                            ...
                            <div class="block mt-4  w-full px-1">
                                ...
                                <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('title', @$details->name)" required autofocus />
                                <x-input-error :messages="$errors->get('name')" class="mt-2" />
                            </div>
                            <div class="block mt-4  w-full px-1">
                                <x-input-label for="email" :value="__('Email')" />
                                <x-text-input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('title', @$details->email)" required autofocus />
